...
function moveSpheres(){
  if(moveConfig.move1) ball1.translateX((moveConfig.destination1.x - ball1.position.x) * moveConfig.alpha1);
  if(moveConfig.move2) ball2.translateX((moveConfig.destination2.x - ball2.position.x) * moveConfig.alpha2);
};
