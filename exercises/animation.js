...
let material3 = setDefaultMaterial('yellow');
let cylinder3 =  new THREE.Mesh( cylinderGeometry2, material3);
cylinder2.add(cylinder3);

let cylinder4 =  new THREE.Mesh( cylinderGeometry2, material3);
...
function rotateCylinder()
{
  ...
  if(animationOn)
  {
    ...
    cylinder3.matrix.multiply(mat4.makeTranslation(0.5, 0.0, 0.0));
    cylinder3.matrix.multiply(mat4.makeRotationX(angle));

    cylinder4.matrix.multiply(mat4.makeRotationZ(THREE.MathUtils.degToRad(90)));
    cylinder4.matrix.multiply(mat4.makeTranslation(-0.5, 0.0, 0.0));
    cylinder4.matrix.multiply(mat4.makeRotationX(-angle2));
  }
}
