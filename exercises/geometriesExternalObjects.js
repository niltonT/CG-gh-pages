...
let assetManager = {
   ...
   checkLoaded : function() {
      if(!this.allLoaded)
      {
         if(this.dolphins && this.vase && this.flowers && 
            this.f16 && this.soccerball && this.toucan && this.cow && this.toon_tank){
             this.allLoaded = true;
             loadingMessage.hide(); 
         }
      }
   ...
   hideAll : function() {
      ...
      this.cow.visible = this.toon_tank.visible = false;
   }
}
...
loadGLBFile('../assets/objects/', 'toon_tank', false, 1.2);
...
function buildInterface()
{
  ...
  gui.add(controls, 'type',
    ['dolphins', 'vase', 'flowers', 'f16', 'soccerball', 'toucan', 'cow','toon_tank'])
    .name("Change Object")
