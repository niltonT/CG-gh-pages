...
var light = initDefaultSpotlight(scene, new THREE.Vector3(5, 5, 5)); // Use default light
...
function generatePoints()
{
  ...
  points.push(new THREE.Vector3(2 * tam, 0, 0));
  points.push(new THREE.Vector3(0, 0, tam));
  points.push(new THREE.Vector3(2 * tam, 0, tam));

  points.push(new THREE.Vector3(0, tam, 0));
  points.push(new THREE.Vector3(0, tam, tam));
  points.push(new THREE.Vector3(tam, tam, 0));
  points.push(new THREE.Vector3(tam, tam, tam));
