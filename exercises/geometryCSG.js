...
let light = initDefaultSpotlight(scene, new THREE.Vector3(5, 5, 5));	
let fromCamera = true;
...
function buildObjects()
{
   ...
   let cylinderMesh = new THREE.Mesh( new THREE.CylinderGeometry(0.85, 0.85, 2.3, 20))
   ...
   cylinderMesh.position.set(0,2.3,0);
   torusMesh.position.set(0.8,2.3,0);
   ...
   cylinderMesh = new THREE.Mesh( new THREE.CylinderGeometry(0.75, 0.75, 2, 20));
   ...
   mesh1.material = new THREE.MeshPhongMaterial({color: 'lightgreen',shininess: "255"})
   mesh1.rotateX(degreesToRadians(90));
   scene.add(mesh1)
...
function buildInterface()
{
  ...
  gui.add(controls, 'fromCamera', true)
    .name("From camera")
    .onChange(function(e) { controls.onCamera() });
}
